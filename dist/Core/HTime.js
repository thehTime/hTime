...
const GlobalHour_1 = require("@/Core/GlobalHour");
const Offset_1 = require("@/Core/Offset");
...
function createHTime(options) {
    ...
    const UTCDate = dateString ? (0, Parse_1.parseToUTCDate)(dateString) : new Date;
    ...
    return Object.freeze({
        ...
        dateString: {
            ...
            hTime: (0, Parse_1.formatIsoUTCDateStringAsHTimeDateString)(UTCDate.toISOString()),
        },
        toString() {
